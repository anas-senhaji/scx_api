    ...
    */
    public function model(array $row)
    {
        ...
        return new UmmcStatistic([
            ...
            'taux_service_medicament' => (empty($row['taux_de_service_medicament']) || trim($row['taux_de_service_medicament']) == '' || trim($row['taux_de_service_medicament']) == '#DIV/0!' || trim($row['taux_de_service_medicament']) == 'infinity%' || trim($row['taux_de_service_medicament']) == '-' || trim($row['taux_de_service_medicament']) == '#N/A') ? NULL : (100 * $row['taux_de_service_medicament']),
